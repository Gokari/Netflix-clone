...
--
ALTER TABLE `billingDetails` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `videoProgress` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `entities` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
